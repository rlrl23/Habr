...
class App extends React.Component {
    constructor(props) {
        ...
        this.state = {
            'articles': [],
            'categories': [{'name': 'Дизайн', 'slug': 'disign'}, {
                'name': 'Маркетинг',
                'slug': 'marketing'
            }, {'name': 'Web разработка', 'slug': 'web_dev'}, {'name': 'Мобильная разработка', 'slug': 'mob_dev'}],
            'comments': [{'id': 1, 'article_id': 1, 'text': 'Гневный комментарий', 'author_id': 1}, {
                'id': 2,
                'article_id': 1,
                'text': 'Хороший комментарий',
                'author_id': 1
            }, {'id': 3, 'article_id': 2, 'text': 'Гневный комментарий', 'author_id': 1}],
            'users': []
        }
    }
